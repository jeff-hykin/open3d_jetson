{
    description = "open3d-unofficial-arm";
    inputs = {
            ...
            in
                {
                    ...
                    home.homeDirectory = "/tmp/virtual_homes/open3d-unofficial-arm";
                    ...
                    programs = {
                        ...
                        zsh = {
                            ...
                            initContent = ''
                                ...
                                # check for .pypirc for publishing to pypi
                                if [ -f "$XOME_REAL_HOME/.pypirc" ]
                                then
                                    rm -f "$HOME/.pypirc"
                                    ln -s "$XOME_REAL_HOME/.pypirc" "$HOME/.pypirc"
                                fi
